...
public class DeltaUserStudy : MonoBehaviour
{
    ...
    private bool IsAnyNavigationPressedThisFrame()
    {
        return Input.GetKeyDown(KeyCode.W)
            ...
            || IsPlaneButtonPressedThisFrame(KeyCode.W, wasPlaneWPressed)
            || IsPlaneButtonPressedThisFrame(KeyCode.A, wasPlaneAPressed)
            || IsPlaneButtonPressedThisFrame(KeyCode.S, wasPlaneSPressed)
            || IsPlaneButtonPressedThisFrame(KeyCode.D, wasPlaneDPressed);
    }

    private bool IsPlaneButtonPressedThisFrame(KeyCode keyCode, bool wasPressedLastFrame)
    {
        return IsPlaneButtonTouched(keyCode) && !wasPressedLastFrame;
    }
    ...
    private bool IsAnyAdjustmentPressed()
    {
        return IsAdjustmentPressed(KeyCode.Q)
            ...
            || IsAdjustmentPressed(KeyCode.R)
            || IsAdjustmentPressed(KeyCode.F)
            || IsAdjustmentPressed(KeyCode.T)
            || IsAdjustmentPressed(KeyCode.G);
    }
